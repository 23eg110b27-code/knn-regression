...
# sklearn imports: guard against missing installation to provide a helpful message in Streamlit
import importlib
try:
    _prep = importlib.import_module("sklearn.preprocessing")
    LabelEncoder = _prep.LabelEncoder
    _model = importlib.import_module("sklearn.model_selection")
    train_test_split = _model.train_test_split
    _neighbors = importlib.import_module("sklearn.neighbors")
    KNeighborsRegressor = _neighbors.KNeighborsRegressor
    _metrics = importlib.import_module("sklearn.metrics")
